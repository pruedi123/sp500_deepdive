...
# --- Format Decline/Unemployment columns as percentages with one decimal place ---
# Match any column containing "decline" or "unemp" (covers 'unemployment' and 'unempolyment')
percent_cols = [col for col in bear_filtered.columns if ("decline" in col.lower() or "unemp" in col.lower())]
for col in percent_cols:
    nums = pd.to_numeric(bear_filtered[col], errors="coerce") * 100
