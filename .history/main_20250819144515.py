...
# Set Streamlit wide layout before title
...
# Choose layout for the bad‑news cards
cards_layout = st.sidebar.radio("Bad-news cards layout", ["2 × 2", "1 × 4"], index=0, horizontal=True)
...
if average_decline is not None and average_duration is not None:
    ...
    st.markdown("During this period there were:\n")
