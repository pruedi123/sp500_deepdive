...
# Build interactive bar chart for Composite, Nominal Dividends, and CPI factors
factors_dict = {
    "Composite": factor,
...
fig = px.bar(factors_df, x="Category", y="Factor", title="Increase Factors", text="Factor")
