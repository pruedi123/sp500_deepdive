...
if pd.notnull(ending_value):
    ...
    withdrawal_fmt = "—"
withdrawal_label = f"{custom_pct:.1f}% Withdrawal"
...
with col2:
    metric_card("Ending Value (Nominal)", ending_value_fmt)
with col3:
    metric_card("CAGR (Nominal Total Return)", cagr_fmt)

col4, col5, _ = st.columns(3)
with col4:
    metric_card("Dividends at Ending Value", dividends_fmt)
with col5:
