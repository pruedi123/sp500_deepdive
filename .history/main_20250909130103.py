...
if year_input_mode == "Dropdown":
    begin_year = st.sidebar.selectbox("Begin Year", years, index=get_default_index(years, 1941))
...
begin_month = st.sidebar.selectbox("Begin Month", months, index=get_default_index(months, 12))
